...
"[project]/Desktop/Fiore/src/app/api/subcategories/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const subcategories = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].subcategory.findMany({
            include: {
                category: true,
                _count: {
                    select: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(subcategories);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const subcategory = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].subcategory.create({
            data: {
                name: body.name,
                categoryId: body.categoryId
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(subcategory);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__60047f80._.js.map