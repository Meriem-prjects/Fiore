...
"[project]/Desktop/Fiore/src/app/api/products/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.findMany({
            where,
            include: {
                category: true,
                subcategory: true,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(products);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.create({
            data: {
                name: body.name,
                price: body.price,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(product);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c827f08._.js.map