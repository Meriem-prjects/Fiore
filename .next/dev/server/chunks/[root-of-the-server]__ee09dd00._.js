...
"[project]/Desktop/Fiore/src/app/api/categories/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const categories = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.findMany({
            include: {
                _count: {
                    select: {
                        products: true,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(categories);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.create({
            data: {
                name: body.name,
                type: body.type,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(category);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ee09dd00._.js.map