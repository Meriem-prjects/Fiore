...
"[project]/Desktop/Fiore/src/app/api/products/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, props) {
    ...
    try {
        ...
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.update({
            where: {
                id: params.id
            },
            data: {
...
async function DELETE(request, props) {
    const params = await props.params;
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Fiore$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.delete({
            where: {
                id: params.id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__937766f9._.js.map